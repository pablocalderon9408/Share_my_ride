    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=250, verbose_name='circle name')),
                ...
                ('is_limited', models.BooleanField(default=False, help_text='Limited circles can grow to a fixed number of members.', verbose_name='limited')),
